                  ...
                  <div class="card card-login">
                    <form class="form" method="POST" action="conexion.php">
                      <div class="card-header card-header-primary text-center">
                        <h4 class="card-title">Recuperación de la cuenta</h4>                        
                      </div>                      
                      <div class="card-body">                        
                        &nbsp;
                        ...
                        <div class="input-group">
                          ...
                          <input type="password"  name="contraseña" class="form-control" placeholder="Repetir Contraseña">
                        </div>                                                                                            
                      <div style="text-align: center">
                        <a href="Login.php" class="btn btn-success">Enviar</a>
                    </div>
                      <hr>
                      <a href="olcontrasenacod.php" class="btn btn-danger">Atras</a>
                      </div>                      
                    </form>
                  </div>
                </div>
