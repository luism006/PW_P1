...
$id_marcas = 1;
	...
	$query = "SELECT id_modelos, modelos.id_marcas FROM marcas INNER JOIN modelos ON marcas.id_marcas=modelos.id_marcas WHERE modelos.id_marcas = '$id_marcas'";
	$resultado =  mysqli_query($connection, $query);
	$row = mysqli_fetch_array($resultado, MYSQLI_ASSOC);
	$marca = $row['id_marcas'];
	$modelo = $row['id_modelos'];
	
	$queryE = "SELECT id_marcas, marcas FROM marcas ORDER BY marcas";
	$resultadoE =  mysqli_query($connection, $queryE);
	
	$queryM = "SELECT id_modelos, modelos FROM modelos WHERE id_marcas = '$marca' ORDER BY modelos";
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb blue-grey lighten-4">
              <li class="breadcrumb-item"><a class="black-text" href="Inicio.php"><strong>Inicio</strong></a><i
                  ...
                  <li class="breadcrumb-item"><a class="black-text" href="paneldc.php"><strong>Panel de Control</strong></a><i
                  class="fas fa-angle-double-right mx-2" aria-hidden="true"></i></li>              
              <li class="breadcrumb-item active"><strong>Edición</strong></li>
          ...
          <div class="col-10 offset-1 col-lg-8 offset-lg-2 div-wrapper d-flex justify-content-center align-items-center">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title">Edición de mercancias</h4>
                <p class="card-category">Edita tu mercancia seleccionada</p>
              </div>
              <div class="card-body">
                    ...
                    if(isset($_POST['edit_btn']))
                      {
                        ...
                        $query = "SELECT * FROM mercancias WHERE id_mercancias='$id_mercancias' ";
                ...
                <input type="hidden" name="edit_id" value="<?php echo $row['id_mercancias']; ?>">  
                  ...
                  <div class="row">
                     <div class="col-md-4">
                       <div class="form-group">
                         ...
                         <select name="edit_marcas" id="edit_marcas" class="form-control" required="">
                             <option value="0">Seleccione</option>
                             <?php while($rowE = $resultadoE->fetch_assoc()) { ?>
                              <option value="<?php echo $rowE['id_marcas']; ?>" <?php if($rowE['id_marcas']==$marca) { echo 'selected'; } ?> ><?php echo $rowE['marcas']; ?></option>
                             <?php } ?>
                             </select>                            
                         </div>
                     </div>                    
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="form-group"> 
                        ...
                        <select name="edit_modelos" id="edit_modelos" class="form-control" required="">
                        <?php while($rowM = $resultadoM->fetch_assoc()) { ?>
                                  <option value="<?php echo $rowM['id_modelos']; ?>" <?php if($rowM['id_modelos']==$modelo) { echo 'selected'; } ?>><?php echo $rowM['modelos']; ?></option>
                                <?php } ?>	
                         </select>            
                          </div> 
                      </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                         ...
                         <select name="edit_tipo" id="edit_tipo" class="form-control" required="">
                         <option value="Motor" <?php if($row['tipo']=="Motor") { echo "selected"; }?>>Motor</option>
                         <option value="Passola" <?php if($row['tipo']=="Passola") { echo "selected"; }?>>Passola</option>
                         </select>                             
                      </div>
                    </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                        ...
                        <input type="number" min="1900" max="2020" name="edit_año" value="<?php echo $row['año']; ?>" class="form-control" required="">
                      </div>
                    </div>
                    ...
                    <div class="col-md-2">
                      <div class="form-group">
                         ...
                         <select name="edit_condicion" id="edit_condicion" class="form-control" required="">
                         <option value="Nuevo" <?php if($row['condicion']=="Nuevo") { echo "selected"; }?>>Nuevo</option>
                         <option value="Usado" <?php if($row['condicion']=="Usado") { echo "selected"; }?>>Usado</option>
                         </select>                             
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                         ...
                         <select name="edit_color" id="edit_color" class="form-control" required="">
                         <option value="Rojo" <?php if($row['color']=="Rojo") { echo "selected"; }?>>Rojo</option>
                         <option value="Amarillo" <?php if($row['color']=="Amarillo") { echo "selected"; }?>>Amarillo</option>
                         <option value="Verde" <?php if($row['color']=="Verde") { echo "selected"; }?>>Verde</option>
                         <option value="Azul" <?php if($row['color']=="Azul") { echo "selected"; }?>>Azul</option>
                         <option value="Negro" <?php if($row['color']=="Negro") { echo "selected"; }?>>Negro</option>
                         <option value="Blanco" <?php if($row['color']=="Blanco") { echo "selected"; }?>>Blanco</option>
                         </select>                             
                      </div>
                    </div>                    
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                         ...
                         <select name="edit_combustible" id="edit_combustible" class="form-control" required="">
                         <option value="Gasolina" <?php if($row['combustible']=="Gasolina") { echo "selected"; }?>>Gasolina</option>
                         <option value="Eléctrico/Híbrido" <?php if($row['combustible']=="Eléctrico/Híbrido") { echo "selected"; }?>>Eléctrico/Híbrido</option>
                         </select>                             
                      </div>
                    </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                         ...
                         <select name="edit_transmision" id="edit_transmision" class="form-control" required="">
                         <option value="Automática" <?php if($row['transmision']=="Automática") { echo "selected"; }?>>Automática</option>
                         <option value="Mecánica" <?php if($row['transmision']=="Mecánica") { echo "selected"; }?>>Mecánica</option>
                         </select>                             
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="number"  min="1" name="edit_cc" value="<?php echo $row['cc']; ?>" class="form-control" required="">
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="number"  min="1" name="edit_precio" value="<?php echo $row['precio']; ?>" class="form-control" required="">
                      </div>
                    </div>
                    </div>  
                  ...
                  <button type="submit" name="actualizarpcbtn" class="btn btn-success center-block">Actualizar</button>
                   <a class="btn btn-danger" href="paneldc.php">Atras</a>
