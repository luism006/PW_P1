                    ...
                    <form class="form" method="POST" action="conexion.php">
                      ...
                      <div class="card-body">                        
                        ...
                        <div class="input-group">
                          ...
                          <input type="password" class="form-control" placeholder="Ingrese Código...">
                        </div>                                                                                            
                      <div style="text-align: center">
                        <a href="olcontrasenanueva.php" class="btn btn-success">Enviar</a>
                    </div>
                      <hr>
                      <a href="olcontrasena.php" class="btn btn-danger">Atras</a>
                      </div>                      
                    </form>
                  </div>
                </div>
