      ...
      <div class="row">
              ...
              <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100">
                  <a href="Perfilus.php"><img <?php echo' class="card-img-top" src="Subidas/'.$row['imagen'].'"  alt="Problema al cargar imagen"'?> ></a>
                  <div class="card-body">"
                  <h4 class="card-title text-light"><?php echo $row["tipo"]; ?></h4>
                        <h5 class="card-title text-link">$ <?php echo $row["precio"]; ?></h5>
                  </div>
