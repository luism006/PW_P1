    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <a class="navbar-brand" href="javascript:void(0)"><i class="fas fa-building"></i><strong>&nbspRegistro</strong></a>
          ...
          <div class="col-10 offset-1 col-lg-8 offset-lg-2 div-wrapper d-flex justify-content-center align-items-center">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title">Registro Empresarial</h4>
                <p class="card-category">Completa tu registro</p>
              </div>
              <div class="card-body">

                <form action="codedatabreg_emp.php"method="POST" enctype="multipart/form-data">
                  
                  <div class="row">
                  <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">Empresa (Nombre)</label>
                          <input  type="text" name="empresas" class="form-control" required="ggg">
                        </div>
                      </div>
                  <div class="col-md-3">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="direccion_emp" class="form-control">
                      </div>
                    </div>
                  </div>
                  ...
                  <button type="submit" name="registrobtn_emp" class="btn btn-success center-block">REGISTRARME</button>
