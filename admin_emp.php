...
<div class="col-md-6 col-sm-6">
      <div class="card card-stats">
          <div class="card-header card-header-success card-header-icon">
            ...
            <p class="card-category">Total empresas Registradas</p>
            <h3 class="card-title">
              <?php


              $query = "SELECT id_empresas FROM empresas ORDER BY id_empresas";
                    ...
                    <table id="dtBasicExample" class="table table-hover ">
                      ...
                      if(mysqli_num_rows($query_run)> 0)
                      {
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['estado_emp']; ?></td>                       
                          <td><?php echo $row['empresas']; ?></td>
                          <td><?php echo $row['email_emp']; ?></td>
                          <td><?php echo $row['representante_emp']; ?></td>
                          <td><?php echo $row['rnc_emp']; ?></td>
                          <td class="text-info"><?php echo date('d-m-Y', strtotime($row['fecha_actual_emp'])); ?></td>
                          
                          
                          <td class="td-actions text-left">
                          <form action="edit_registro.php" method="post">
                            <input type="hidden" name="edit_id" value="<?php echo $row['id_empresas']; ?>">         
...
<div id="deletemodal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modaleliminar" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="codedatabreg_empadm.php" method="POST">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #202940;">
        <h5 class="modal-title" style="color: #ffffff;" id="exampleModalLabel">REGISTRO EMPRESA</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="codedatabreg_empadm.php"method="POST" enctype="multipart/form-data">
      <div class="modal-body" style="background-color: #202940;">

      <div class="row">
                  <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">Empresa (Nombre)</label>
                          <input  type="text" name="empresas" class="form-control" required="">
                        </div>
                      </div>
                  <div class="col-md-3">
                      <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="password" name="contraseña_emp" class="form-control" required="">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-2">
                      <div class="form-group">
                        <label class="bmd-label-floating">Rnc</label>
                        <input  type="number"  min="000000000" name="rnc_emp" class="form-control" required="">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="bmd-label-floating">Ncf</label>
                        <input type="text" name="ncf_emp" class="form-control" required="">
                      </div>
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="bmd-label-floating">Representante</label>
                        <input type="text" name="representante_emp" class="form-control" required="">
                      </div>
                    </div>

                  <div class="col-md-4">
                      <div class="form-group">
                        <label class="bmd-label-floating">Representante (Teléfono)</label>
                        <input type="tel" name="tel_representante_emp" class="form-control" required="">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">                      
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="tel" name="telefono_emp" class="form-control" required="">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          <label class="bmd-label-floating"> A que se dediaca tu empresa?</label>
                          <textarea type="text" name="descripcion_emp" class="form-control" rows="5" required=""></textarea>
                        </div>
                      </div>
                    </div>
                    </div>
                  ...
                  <input type="hidden" name="estado_emp" value="A">
                  <input type="hidden" name="fecha_actual_emp" value="<?= $fecha_actual?>">
                  <input type="hidden" name="rolusuario_emp" value="empresa">
      
      </div>
      <div class="modal-footer" style="background-color: #202940;">
      <button type="submit" name="registrobtn_empadm" class="btn btn-success center-block">REGISTRARME</button>
